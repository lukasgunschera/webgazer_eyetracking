...
datAoi <- subset(datAoi, select = c("ID","qual_id","trials_ran","completion","consent","webcam","webcam_type",
                                    ...
                                    "selection","selection_trial","trackloss","attracted","pair_gender","gender_match"))
...
length(sequence_window_clean$Prop[sequence_window_clean$TimeBin == -1|sequence_window_clean$TimeBin == -2])
...
list.save(data_window_clean, 'data_window_clean.rds')
